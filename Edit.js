...
function initializeNavigation() {
  ...
  const sectionIds = ['experience', 'systems', 'skills', 'ask-shelton', 'contact'];
...
function initializeReveal() {
  const targets = document.querySelectorAll('.section-heading-wrap, .experience-feature, .experience-secondary, .system-card, .skills-grid article, .assistant-copy, .agent-console, .contact-card');
